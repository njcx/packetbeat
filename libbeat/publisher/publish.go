...
import (
	...
	_ "packetbeat/libbeat/outputs/console"
	_ "packetbeat/libbeat/outputs/elasticsearch"
	_ "packetbeat/libbeat/outputs/fileout"
	_ "packetbeat/libbeat/outputs/kafka"
	_ "packetbeat/libbeat/outputs/logstash"
	_ "packetbeat/libbeat/outputs/redis"

	// load support output codec
	_ "packetbeat/libbeat/outputs/codecs/format"
	_ "packetbeat/libbeat/outputs/codecs/json"
)
