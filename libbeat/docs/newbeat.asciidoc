...
https://packetbeat/blob/master/CONTRIBUTING.md[Contributing Guide].
...
`$GOPATH/src/packetbeat` path. You can ignore the "no buildable Go source files" message because
...
----------------------------------------------------------------------
{
  ...
  "path": "./vendor/packetbeat/winlogbeat/winlogbeat.yml",
  "type": "lsbeat"
}

{
  ...
  "filesize": 238,
  "modtime": "2016-07-13T20:56:21.000Z",
  "path": "./vendor/packetbeat/winlogbeat/tests/system",
  "type": "lsbeat"
}
----------------------------------------------------------------------
...
[source,shell]
--------------------
python $GOPATH/src/packetbeat/script/generate.py
--------------------
