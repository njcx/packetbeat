...
https://packetbeat/blob/master/packetbeat/CONTRIBUTING.md[CONTRIBUTING]
file on GitHub.
...
$ git clone https://packetbeat.git
----------------------------------------------------------------------
...
* In the `$GOPATH/src/packetbeat` folder, add your fork
...
https://packetbeat/tree/master/packetbeat/scripts/tcp-protocol.
