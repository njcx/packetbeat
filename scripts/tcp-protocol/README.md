...
```
  $ cd ${GOPATH}/src/packetbeat/protos
  $ python ${GOPATH}/src/packetbeat/script/create_tcp_protocol.py
```

Load plugin into packetbeat by adding `_ "packetbeat/protos/echo"` to packetbeat import list in `$GOPATH/src/packetbeat/main.go`
